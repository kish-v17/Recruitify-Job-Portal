<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Recruitify.Index" Theme="Skin1" %>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtSrchTitle" CssClass="form-control" placeholder="Job Title" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtSrchLocation" CssClass="form-control" placeholder="Job Location" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="about-image-wrap custom-border-radius-start">
                                ...
                                <div class="about-info">
                                    <h4 class="text-white mb-0 me-2">Allyse Perry</h4>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-text-block">
                                ...
                                <p class="text-white">Recruitify Job is a free website template for job portals. This layout is based on Bootstrap 5 CSS framework. Thank you for visiting <a href="https://www.tooplate.com" target="_parent">Tooplate website</a>. Images are from <a href="https://www.freepik.com/" target="_blank">FreePik</a> website.</p>
