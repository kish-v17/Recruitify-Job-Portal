<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/EmployerMaster.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Recruitify.Employer.Index" %>
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <div class="categories-block">
                                <a href="#" class="d-flex flex-column justify-content-center align-items-center h-100">
                                    ...
                                    <small class="categories-block-title">Your Uploads</small>
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="job-details.aspx" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="job-details.aspx" class="job-title-link">Business Director</a>
                                        </h4>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="job-listings.aspx" class="badge badge-level">Senior</a href="job-listings.aspx">
                                                </p>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="job-details.aspx" class="job-title-link">Dev Ops</a>
                                        </h4>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="job-details.aspx" class="job-title-link">UX Designer</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="../ob-details.aspx" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-12 recent-jobs-bottom d-flex ms-auto my-4">
                            <a href="job-listings.aspx" class="custom-btn btn ms-lg-auto">Browse Job Listings</a>
                        </div>
                            ...
                            <div class="owl-carousel owl-theme reviews-carousel">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-body">
                                        ...
                                        <h4 class="reviews-title">Recruitify - A Game Changer for Our Hiring Needs. </h4>
                                    </div>
                                </div>
                                <div class="reviews-thumb">
                                    <div class="reviews-info d-flex align-items-center">
                                    ...
                                    <div class="reviews-body">
                                        ...
                                        <h4 class="reviews-title">Efficient and Effective Recruitment Partner.</h4>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 ms-auto">
                            <div class="custom-border-btn-wrap d-flex align-items-center mt-lg-4 mt-2">
                                <a href="job-post.aspx" class="custom-btn custom-border-btn btn me-4">Post a job</a>

                                <a href="insert-company.aspx" class="custom-link">Add a company</a>
                            </div>
                        </div>
